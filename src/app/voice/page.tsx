    ...
    <div className="min-h-screen py-4 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-4 sm:mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card text-xs text-muted-foreground mb-3 sm:mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-primary" />
            {t.badge}
          </div>
          <h1 className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-foreground">{t.pageTitle}</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="rounded-2xl border border-border bg-card overflow-hidden">
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-border flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--accent))] flex items-center justify-center">
            ...
            <div className="px-4 sm:px-6 py-8 sm:py-12 flex flex-col items-center justify-center min-h-[240px] sm:min-h-[300px]">
              {status === "idle" && (
          ...
          <div className="rounded-2xl border border-border bg-card overflow-hidden flex flex-col">
            ...
            <div ref={transcriptRef} className="flex-1 overflow-y-auto px-4 sm:px-6 py-3 sm:py-4 space-y-3 sm:space-y-4 min-h-[250px] sm:min-h-[400px] max-h-[350px] sm:max-h-[500px]">
            ...
            {(status === "connected" || status === "ended") && (
              <div className="px-4 sm:px-6 py-2.5 sm:py-3 border-t border-border grid grid-cols-3 gap-2 sm:gap-4">
